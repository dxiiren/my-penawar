...
<html lang="en">
	...
	<head>
<?php $pageTitle = 'My Profile — Poliklinik Penawar'; include 'partials/head.php'; ?>
...
<?php $active = 'profile'; $profileHref = 'patient profile.php'; include 'partials/nav.php'; ?>
		...
		<section class="bg-gradient-to-b from-teal-50/70 to-white">
			<div class="mx-auto max-w-3xl px-4 pb-8 pt-16 text-center sm:px-6">
				...
				<h1 class="mt-3 text-4xl font-extrabold tracking-tight text-slate-900">My Profile</h1>
				<p class="mt-3 text-sm leading-6 text-slate-600">Your registered details, kept up to date for every visit.</p>
			</div>
		</section>
									...
									foreach($result as $row)
									{
										...
										echo "<table class=\"styled-table\" align=\"center\">";
											...
											echo "<tr class=\"active-row\">";
												...
												echo "<td>" .$row['patientPhoneNum']. "</td>";
											echo "</tr>";
            ...
            $connect = mysqli_connect($hostname, $username, $password, $dbname) OR DIE("Connection Failed");
             ...
             //PHP for EDIT PROFILE form
                 ...
                 if(isset($_POST["submit"]))
				{
					  ...
					  $sql= "UPDATE patient
						 SET patientEmail='$newEmail', patientPhoneNum='$newPhone',
						 patientAddress='$newAddress', patientName='$newName',
						 patientBirthDate='$newBdate'
		...
		<div class="mt-10 flex flex-wrap justify-center gap-3">
			...
			<a href="patient booking.php" class="btn-primary px-6 py-3"><i class="fa-regular fa-calendar-check"></i> Make Appointment</a>
			<a href="appList2.php" class="btn-outline px-6 py-3"><i class="fa-solid fa-clock-rotate-left"></i> Appointment History</a>
		</div>
		</div>

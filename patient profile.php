<html>
	...
	<body>
		...
		<!-- button options-->			
		<center>
			<a href="#divOne"><button class="btn3"><b style="font-family: 'Playfair Display SC', serif;"> Edit Profile </b></button></a>
			<a href="patient booking.php"><button class="btn3"><b style="font-family: 'Playfair Display SC', serif;"> Make Appointment</b></button></a>		
			<a href="appList2.php"><button class="btn3"><b style="font-family: 'Playfair Display SC', serif;"> Appointment History</b></button></a>		
		</center>
		</div>
